...
-- declared in the HodzaLabs.hs file.
module Settings
    ( hamletFile
    , cassiusFile
    , juliusFile
...
--
-- If you change the resource pattern for StaticR in HodzaLabs.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in HodzaLabs.hs
staticroot :: String
